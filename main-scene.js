    ...
    class Record_Player_Simulator extends Simulation {
        constructor(context, control_box) {
            ...
            this.materials =
            {
                ...
                record_tex2: context.get_instance( Phong_Shader).material(Color.of(0,0,0,1), {ambient: 1, specularity: .9, texture:context.get_instance("assets/record_tex2.jpg", false)}),
            }
            ...
            this.room_height = 20;
            this.room_width = 30;     
            this.bodies.push(new Wall(this.shapes.cube, this.materials.phong_secondary, Vec.of(1, this.room_height, this.room_length), false, this.aabb.cube, Vec.of(1, 0, 0))
                       .emplace(Mat4.translation(Vec.of(-30, 18, 45)), Vec.of(0, 0, 0), 0));
            this.bodies.push(new Wall(this.shapes.cube, this.materials.phong_secondary, Vec.of(1, this.room_height, this.room_length), false, this.aabb.cube, Vec.of(-1, 0, 0))
                       .emplace(Mat4.translation(Vec.of(30, 18, 45)), Vec.of(0, 0, 0), 0));
            this.bodies.push(new Wall(this.shapes.cube, this.materials.phong_secondary, Vec.of(this.room_width, this.room_height, 1), false, this.aabb.cube, Vec.of(0, 0, -1))
                       .emplace(Mat4.translation(Vec.of(0, 18, 95)), Vec.of(0, 0, 0), 0));
            this.bodies.push(new Wall(this.shapes.cube, this.materials.phong_secondary, Vec.of(this.room_width, 1, this.room_length), false, this.aabb.cube, Vec.of(0, 1, 0))
